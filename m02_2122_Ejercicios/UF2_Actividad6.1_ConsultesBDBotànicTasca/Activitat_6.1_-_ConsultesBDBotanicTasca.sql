...
/* ACTIVIDAD 6.1 - CONSULTES BD BOTANIC */

-- Tasca 1.
/*
SELECT id_planta, nom_popular
	FROM planta
    WHERE id_estacio = 'Estiu';
*/
-- Tasca 2.
/*
SELECT id_planta nom_cientific, nom_popular popular
	FROM planta
	WHERE id_estacio IN ('Hivern', 'Tardor');
*/
-- Tasca 3.
/*
...
SELECT id_adob, tipus
	FROM adob
    WHERE id_firma_comercial = 'Prisadob';
*/
-- Tasca 5.
/*
SELECT id_planta
...
SELECT DISTINCT id_planta
    ...
    -- WHERE quantitat >= 40 AND quantitat <= 50; -- Equivalente
*/
-- Tasca 7.
/*
SELECT DISTINCT id_planta
...
-- Tasca 9.
/*
SELECT id_adob, id_firma_comercial
	FROM adob
    WHERE id_firma_comercial IN ('Cirsadob', 'Tirsadob');
*/
-- Tasca 10.
/*
SELECT DISTINCT id_planta
...
SELECT id_adob
	FROM adob
    WHERE tipus = 'AI' AND (id_firma_comercial LIKE 'T%' OR id_firma_comercial LIKE 'P%');
*/
