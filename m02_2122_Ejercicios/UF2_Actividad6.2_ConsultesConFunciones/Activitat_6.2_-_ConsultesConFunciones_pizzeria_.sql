...
SELECT COUNT(id_ingredient) AS "Nombre d'ingredients"
	FROM pizza_ingredient
    WHERE id_producte = '7';

-- Tasca 9. Mostra la quantitat de pizzes que porten Carn.

SELECT COUNT(id_producte)
	FROM pizza_ingredient
    WHERE id_ingredient = 'CAR';
...
SELECT numero, WEEKDAY(data_hora) -- 0 = LUNES, 1 = MARTES, 2 = MIERCOLES...
	FROM comanda;